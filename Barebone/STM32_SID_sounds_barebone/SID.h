...
uint8_t multiplier  = 48;//                   ----   Can't autoconfig without any sid data loaded, this is just wild guess   --- maximum is 255 --- best when under 64 --- DO NOT set it to 0 ---
...
const uint8_t ADSR_Volume2LFSR5 [] = { // clock divider that drive ADSR_Volume counter, and is readed from ADSR_Volume value
 ...
 0x01, 0x1e, 0x1e, 0x1e, 0x1e, 0x1e, 0x10, 0x10,
